...
function MainContent({ uiConfig, activeEntity, toast }) {
// 🔥 UI MODE (takes priority)
if (uiConfig) {
const type = uiConfig.type;
const fields = Array.isArray(uiConfig.fields) ? uiConfig.fields : [];
...
// ✅ UNKNOWN COMPONENT (THIS FIXES YOUR BUG)
return (
  <div style={{ padding: 20, textAlign: 'center' }}>
    <h3 style={{ color: 'red' }}>
      Unsupported component: {String(type)}
    </h3>
  </div>
);
```
...
// ✅ ENTITY MODE (your original app)
if (activeEntity) {
return <EntityApp entity={activeEntity} toast={toast} />;
}

// ✅ FALLBACK
return (
<div style={{ padding: 20, textAlign: 'center' }}> <p>No UI or entities found</p> </div>
);
}
